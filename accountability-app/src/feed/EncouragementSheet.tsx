...
const styles = StyleSheet.create({
  ...
  replyText: { color: colors.primaryDark, fontFamily: font.semibold, fontSize: 10.5 },
  ...
  recordVoiceText: { color: colors.primaryDark, fontFamily: font.semibold, fontSize: 12 },
  ...
  retry: { color: colors.primaryDark, fontFamily: font.bold, minHeight: 48 },
  ...
  smallAction: { color: colors.primaryDark, fontFamily: font.semibold, fontSize: 11 },
