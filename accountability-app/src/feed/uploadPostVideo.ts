import { uploadBytesToR2, uploadBytesToR2WithDigest, type R2UploadedMedia } from '../lib/r2';
...
export async function uploadPostVideoWithDigest(
  uri: string,
  mimeType: string,
  operationId?: string,
  expectedOwnerId?: string,
  ...
  return uploadBytesToR2WithDigest(bytes, 'video', mimeType, ext, {
    operationId,
    expectedOwnerId,
  });
}
