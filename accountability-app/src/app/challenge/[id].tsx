...
const createStyles = (palette: CompetitionPalette) => StyleSheet.create({
  ...
  meta: { fontFamily: font.semibold, fontSize: 13.5, color: palette.accent },
  range: { fontFamily: font.medium, fontSize: 12.5, color: palette.inkSoft, marginBottom: 8 },
  joinBtn: {
    backgroundColor: palette.accent,
    borderRadius: radius.pill,
    paddingVertical: 12,
  ...
  inviteText: { color: palette.accent, fontFamily: font.bold, fontSize: 13.5 },
