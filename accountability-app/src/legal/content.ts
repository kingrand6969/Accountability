...
export const TERMS: LegalDoc = {
  ...
  sections: [
    ...
    },
    {
      h: '2. What the app is',
      p: [
        `${OPERATOR} is a social accountability and fitness app. It lets you track activities and habits, record runs and workouts, connect with accountability buddies, chat, share posts and stories, join challenges, keep private "Memories", and use AI to estimate calories and macros from a food photo. The food scan is an informational tool — see the health and AI disclaimers below.`,
    ...
    },
    {
      ...
      p: [
        'The food scanner uses AI to estimate calories and macros from a photo. These results are automated ESTIMATES and can be wrong, sometimes by a lot. Food scans are a rough guide only — they are not nutritional, dietary, or medical advice.',
        'Do not rely on an AI estimate for any decision where getting it wrong could hurt you: managing diabetes or blood sugar, dosing insulin or other medication, avoiding an allergen, following a medically prescribed diet, recovering from an eating disorder, or nutrition during pregnancy. Always check an estimate against the real food and its label where available. If a number matters to your health, verify it yourself or ask a qualified professional.',
      ],
    },
    {
  ...
  sections: [
    ...
    },
    {
      ...
      p: [
        ...
        'To run the app and give you the features you sign up for (account, buddies, feed, chat, run tracking, food scanning, and Pro) — because it’s necessary to perform our agreement with you (the Terms).',
    ...
    },
    {
      ...
      p: [
        ...
        'Separately, if you use the food-photo scanner, an AI service processes the image you submit to estimate calories and macros. These estimates are guidance only (see the Terms) and are not used to make decisions about your account.',
      ],
    },
    {
