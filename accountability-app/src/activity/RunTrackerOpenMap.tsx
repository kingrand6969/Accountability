...
export function RunTrackerOpenMap({
  ...
  const secondaryTop = layout.secondaryRailBottom - 44;
  const mapToolsTop = Math.min(
    layout.statusTop - layout.controlSize * 2 - 28,
    safeTop + 188,
  );
  ...
  return (
    <View pointerEvents="box-none" style={StyleSheet.absoluteFill} testID="run-open-map-chrome">
      ...
      <View pointerEvents="box-none" style={[styles.mapTools, { right: contentLeft, top: mapToolsTop }]}>
        <Pressable
          accessibilityRole="button"
      ...
      >
        ...
        <View accessible={false} style={styles.statusCopy}>
          <Text accessible={false} maxFontSizeMultiplier={1.35} style={styles.statusTitle}>
            {statusTitle}
          </Text>
          <Text accessible={false} maxFontSizeMultiplier={1.35} style={styles.statusDetail}>
            {statusDetail}
          </Text>
        </View>
      </View>
      ...
      >
        ...
        >
          ...
          <Text accessible={false} maxFontSizeMultiplier={1.5} style={styles.metricLabel}>
            DISTANCE
          </Text>
        </View>
      ...
      >
        ...
        >
          ...
          <View accessible={false} style={styles.secondaryCopy}>
            <Text accessible={false} maxFontSizeMultiplier={1.35} style={styles.secondaryValue}>
              {pace}
            </Text>
            <Text accessible={false} maxFontSizeMultiplier={1.35} style={styles.secondaryLabel}>
              PACE /KM
            </Text>
          </View>
        </View>
...
const styles = StyleSheet.create({
  ...
  mapTools: { position: 'absolute', gap: 10 },
  status: {
    position: 'absolute',
    flexDirection: 'row',
    alignItems: 'center',
