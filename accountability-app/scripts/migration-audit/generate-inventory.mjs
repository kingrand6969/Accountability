...
if (process.argv.includes('--refresh-ledger-crlf')) {
  ...
  for (const migration of frozen.migrations) {
    ...
    migration.sha256 = sha256(materializeCrlf(blob));
  }
